  ...
  return (
    <div style={s.container}>
      ...
      <div style={s.headerBox}>
        ...
        <h1 style={s.mainTitle}>FACTOR ESFUERZO</h1>
      ...
      <div style={s.contentBody} className="custom-scrollbar">
        <AccordionSection title="Costo Oculto de la Eficiencia" tag="#Contexto" isOpen={sectionsState.contexto} onClick={() => toggle('contexto')}>
          <p style={s.bodyText}>La red ferroviaria japonesa es un motor económico, pero genera un fenómeno de centralización. Este proyecto mide la desigualdad de acceso que experimentan los activos culturales regionales no conectados a la red principal.</p>
        </AccordionSection>

        <AccordionSection title="Minería de Datos Espaciales" tag="#Metodología" isOpen={sectionsState.metodologia} onClick={() => toggle('metodologia')}>
          <p style={s.bodyText}>Se extrajeron puntos de atracción turística y estaciones de tren mediante web scraping. Se calculó el <strong>Factor de Esfuerzo</strong> usando herramientas de distancia mínima y densidad de conexión en radios de 500m.</p>
        </AccordionSection>

        <AccordionSection title="Fractura Estructural" tag="#Hallazgos" isOpen={sectionsState.hallazgos} onClick={() => toggle('hallazgos')}>
          <p style={s.bodyText}>El análisis revela un aislamiento sistemático del patrimonio natural frente a los centros comerciales. La infraestructura actual actúa como una herramienta de centralización que margina la riqueza cultural periférica.</p>
        </AccordionSection>
      </div>
